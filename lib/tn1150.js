...
function generateLowerCaseTable () {
  ...
  for (i = 0x0391; i <= 0x03A1; i++) {
    lowerCaseTable[i] = i + 0x0020
  }
  for (i = 0x03A3; i <= 0x03A9; i++) {
    lowerCaseTable[i] = i + 0x0020
  }
  ...
  for (i = 0x0410; i <= 0x0418; i++) {
    lowerCaseTable[i] = i + 0x0020
  }
  for (i = 0x041A; i <= 0x042F; i++) {
    lowerCaseTable[i] = i + 0x0020
  }
  for (i = 0x0460; i <= 0x0474; i = i + 2) {
    lowerCaseTable[i] = i + 0x0001
  }
  for (i = 0x0478; i <= 0x0480; i = i + 2) {
    lowerCaseTable[i] = i + 0x0001
  }
  for (i = 0x0490; i <= 0x04BE; i = i + 2) {
    lowerCaseTable[i] = i + 0x0001
  }
  ...
  for (i = 0x10A0; i <= 0x10C5; i++) {
    lowerCaseTable[i] = i + 0x0030
  }
  for (i = 0x200C; i <= 0x200F; i++) {
    lowerCaseTable[i] = 0x0000
  }
  for (i = 0x202A; i <= 0x202E; i++) {
    lowerCaseTable[i] = 0x0000
  }
  for (i = 0x206A; i <= 0x206F; i++) {
    lowerCaseTable[i] = 0x0000
  }
  for (i = 0x2160; i <= 0x216F; i++) {
...
function HFSPlusFastUnicodeCompare (str1, str2) {
  var lowerCaseTable = exports.table
